...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white relative overflow-hidden">
      ...
      <a
        href="https://github.com/cmoore1776/resume-showcase"
        target="_blank"
        rel="noopener noreferrer"
        className="absolute top-6 right-6 z-20 group"
        aria-label="View source on GitHub"
      >
        <div className="flex items-center gap-2 px-4 py-2 bg-slate-900/80 backdrop-blur-sm border border-slate-700/50 rounded-lg hover:border-slate-600 transition-all duration-300 shadow-lg hover:shadow-slate-700/50">
          ...
          <span className="text-sm font-medium text-slate-400 group-hover:text-white transition-colors">Source</span>
        </div>
      </a>
